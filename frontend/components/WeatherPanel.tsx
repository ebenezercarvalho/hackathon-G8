...
const WeatherPanel: React.FC<WeatherPanelProps> = ({ weather, lang }) => {
  ...
  if (!weather) {
    return (
      <div className="bg-slate-900 border border-slate-700 rounded-xl p-8 shadow-2xl flex items-center justify-center text-center min-h-[200px]">
        <div className="max-w-md">
          <Cloud className="text-slate-600 mx-auto mb-4" size={48} aria-hidden="true" />
