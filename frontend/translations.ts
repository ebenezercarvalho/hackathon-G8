...
export const translations = {
  en: {
    ...
    highDelayProb: "High Probability of Delay",
    onTimeLikely: "On Time Departure Likely",
  ...
  pt: {
    ...
    highDelayProb: "Alta Probabilidade de Atraso",
    onTimeLikely: "Partida no Horário Provável",
  ...
  es: {
    ...
    highDelayProb: "Alta Probabilidad de Retraso",
    onTimeLikely: "Salida a Tiempo Probable",
